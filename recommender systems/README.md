...
- Graph Neural Networks for Social Recommendation. (WWW, 2019) [[paper](http://arxiv.org/abs/1902.07243)] (emmm; empirical; GNN; social)
- Lecture Notes: Temporal Point Processes and the Conditional Intensity Function. (2018) [[paper](http://arxiv.org/abs/1806.00221)] (theory; seminal; wow; TPP)
...
- Recurrent Marked Temporal Point Processes: Embedding Event History to Vector. (KDD, 2016) [[paper](https://dl.acm.org/doi/10.1145/2939672.2939875)] (novel; seminal; empirical; TPP)
